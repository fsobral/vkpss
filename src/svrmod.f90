...
!         svrevalfc,svrevalgjac,svrevalgjacp,svrevalhl,svrevalhlp
    ...
    nvparam = 5
    vparam(1) = 'SAFEMODE'
    vparam(2) = 'LINEAR-SYSTEMS-SOLVER-IN-ACCELERATION-PROCESS MA57 MC64'
    vparam(3) = 'LINEAR-SYSTEMS-SOLVER-IN-TRUST-REGIONS MA57 MC64'
!    vparam(4) = 'NEWTON-LINE-SEARCH-INNER-SOLVER'
!    vparam(4) = 'TRUNCATED-NEWTON-LINE-SEARCH-INNER-SOLVER'
    vparam(4) = 'TRUST-REGIONS-INNER-SOLVER'
    vparam(5) = 'LINEAR-SYSTEMS-SOLVER-IN-NEWTON-LINE-SEARCH MA57 MC64'
